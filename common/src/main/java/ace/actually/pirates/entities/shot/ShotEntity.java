...
public class ShotEntity extends ThrowableItemProjectile implements ItemSupplier {
    ...
    {
        super(Pirates.SHOT_ENTITY_TYPE.get(),world);
    }

    public ShotEntity(EntityType<? extends ThrowableItemProjectile> shotEntityEntityType, Level level) {
    ...
    protected void onHitBlock(BlockHitResult blockHitResult) {
        ...
        {
            level().setBlockAndUpdate(blockHitResult.getBlockPos(), Pirates.HEAVY_BLOCK.get().defaultBlockState());
        }
    ...
    protected Item getDefaultItem() {
        return Pirates.CANNONBALL_ENT.get();
    }
