...
public class FriendlyPirateModel<T extends FriendlyPirateEntity> extends SinglePartEntityModel<T> implements ModelWithArms, ModelWithHead {
    ...
    public FriendlyPirateModel(ModelPart root) {
        this.root = root;
